...
isLoading =false;
 setState((){
     ...
     if (response['status'] =="success") {
       Navigator.of(context).pushNamedAndRemoveUntil("choose_department", (route) => false);
     }else{
      print("signup fail");
     }
}     
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body:isLoading==true?Center(child: CircularProgressIndicator(),): Center(
        child: Padding(
          ...
          Form(
            ...
            child: ListView(
              children: [
                ...
                Center(child: Text('Create an account',style: TextStyle(color: Color(0xFF102C57),fontSize: 30,fontFamily:'Ephesis-Regular'),)),
                SizedBox(height: 20,),
